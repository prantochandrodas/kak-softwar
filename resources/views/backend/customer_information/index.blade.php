    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">{{ __('messages.customer_list') }}</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <a href="{{ route('customer-information.create') }}"
                class="btn btn-sm fw-bold btn-primary">{{ __('messages.add') }}</a>
            <!--end::Primary button-->
        </div>
        @php
...
<script>
    ...
    $(document).ready(function() {
        table = $('#featuredProjectTitleHeading').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('customer-information.getdata') }}',
                data: function(d) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        // যদি data null বা খালি থাকে তাহলে default image দেখাও
                        let imagePath = data ?
                            '{{ asset('uploads/customer') }}/' + data :
                            '{{ asset('uploads/supplier/default.png') }}';

                        return '<img src="' + imagePath + '" height="100"/>';
                    },
                    orderable: false,
                    searchable: false
                },
    ...
    $(document).on('click', '.show', function() {
        ...
        $.ajax({
            url: '/admin/customer-information/show/' + dataId,
            type: 'GET',
    ...
    $(document).on('click', '.toggle-status', function() {
        var id = $(this).data('id');
        $.ajax({
            url: '{{ route('customer-information.toggleStatus') }}',
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                id: id
