            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('messages.edit_customer') }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">{{ __('messages.edit_customer') }}</h4>
                    </div>
                    <!--begin::Card body-->
                    <div class="card-body py-4">


                        <form action="{{ route('customer-information.update', $data->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            ...
                                            value="{{ $data->phone }}" placeholder="{{ __('messages.phone') }} ">
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ asset('uploads/customer/' . $data->picture) }}" alt=""
                                            style="width: 100px">
                                        @error('picture')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ asset('uploads/customer/' . $data->signature) }}" alt=""
                                            style="width: 100px">
                                        @error('signature')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="status" class="form-label fw-bold text-dark">{{ __('messages.status') }}
                                        :</label><br>
