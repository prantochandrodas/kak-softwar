...
@section('main')
    <div class="container py-4">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <form action="{{ route('sale-payment-list') }}" method="GET" class="row g-3 payment-box">
                    @php
                    ...
                    @endif
                    <div class="col-md-3">
                        <label for="customer_id" class="form-label fw-semibold">{{ __('messages.customer') }}</label>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="printableArea">
                        <div class="text-center mb-3">
                            ...
                            @endif
                            <h4 class="fw-bold">{{ __('messages.sale') }} {{ __('messages.payment_list') }}</h4>
                            <p class="mb-0">
                                {{ __('messages.date') }}:
                                {{ \Carbon\Carbon::parse(request('from_date') ?? $today)->format('d/m/Y') }} -
                                {{ \Carbon\Carbon::parse(request('to_date') ?? $today)->format('d/m/Y') }}
                            </p>
