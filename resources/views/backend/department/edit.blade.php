...
<div class="modal-header" style="background-color: #333333; border-bottom: 1px solid #ccc;">
    <h5 class="modal-title" id="dataEditModalLabel" style="color: #ffffff;">এডিট ডাটা</h5>
    ...
    <form id="dataEditModalForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <label for="name" class="form-label fw-bold text-dark">নাম:</label>
                <input type="text" class="form-control border-dark" id="name" name="name"
                    placeholder="নাম লিখুন" value="{{ $data->name }}">
        ...
        <div class="col-md-12 mb-3">
            <label for="status" class="form-label fw-bold text-dark">স্ট্যাটাস:</label><br>
...
<script>
    $(document).ready(function() {
        ...
        $("#dataEditModalForm").on("submit", function(e) {
            ...
            $.ajax({
                url: "{{ route('department.update', ':id') }}".replace(':id', sliderId),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href =
                            "{{ route('department.index') }}?added-successfully=" +
