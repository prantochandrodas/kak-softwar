    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background-color: #f8f9fa; border-radius: 8px; border: 1px solid #ddd;">
            ...
            <div class="modal-header" style="background-color: #333333; border-bottom: 1px solid #ccc;">
                <h5 class="modal-title" id="dataCreateModalLabel" style="color: #ffffff;">ডেটা তৈরি করুন</h5>
                ...
                <form id="dataCreateModalForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="department_id" class="form-label fw-bold text-dark">ডিপার্টমেন্ট:</label>
                        ...
                        <!-- name -->
                        <div class="col-md-12 mb-3">
                            <label for="name" class="form-label fw-bold text-dark">পদবী:</label>
                            <input type="text" class="form-control border-dark" id="name" name="name"
                                placeholder="পদবী নাম লিখুন">
            ...
            <div class="modal-footer" style="background-color: #f8f9fa; border-top: 1px solid #ccc;">
                <button type="button" class="btn"
                    style="background-color: #FF4C29; color: #ffffff; border-radius: 5px;" data-bs-dismiss="modal">বন্ধ
                    করুন</button>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $("#dataCreateModalForm").on("submit", function(e) {
            ...
            $.ajax({
                url: "{{ route('designation.store') }}", // Laravel route for storing data
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
