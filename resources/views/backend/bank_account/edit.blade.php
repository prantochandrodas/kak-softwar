            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('messages.edit_bank_account') }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('messages.edit_bank_account') }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">{{ __('messages.edit_bank_account') }}</h4>
                    </div>
                    <!--begin::Card body-->
                    <div class="card-body py-4">
                        ...
                        <form action="{{ route('bank-account.update', $data->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="bank_branch_id" class="form-label">{{ __('messages.branch') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="account_name" id="account_name"
                                            ...
                                            placeholder="{{ __('messages.account') }}
                                            {{ __('messages.name') }}">
                                        @error('account_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="account_type" id="account_type"
                                            ...
                                            <option value="Saveing"
                                                {{ $data->account_type == 'Saveing' ? 'selected' : '' }}>Saveing</option>
                                        </select>
                                        @error('account_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="status"
                                        class="form-label fw-bold text-dark">{{ __('messages.status') }}
                                        :</label><br>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#bank_id').on('change', function() {
                let dataId = $(this).val();
                let selectedId = data?.bank_branch_id ?? '';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data.data, function(key, value) {
                                let isSelected = selectedId == value.id ?
                                    'selected' : '';
