    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted"> {{ __('messages.supplier_list') }} </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <a href="{{ route('supplier.create') }}" class="btn btn-sm fw-bold btn-success">
                {{ __('messages.add') }}</a>
            <!--end::Primary button-->
        </div>
        @php
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form id="filterForm" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            <label for="name" class="form-label mb-1"> {{ __('messages.supplier') }}
        ...
        <table id="featuredProjectTitleHeading" class="display" style="width:100%">
            <thead>
                <tr>
                    ...
                    @endif
                    <th>{{ __('messages.supplier') }} {{ __('messages.name') }}</th>
                    <th>{{ __('messages.phone') }} {{ __('messages.number') }}</th>
...
<script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return '<img src="' + '{{ asset('uploads/supplier/') }}' + '/' + data +
    ...
    $(document).on('click', '.show', function() {
        ...
        $.ajax({
            url: '/admin/supplier/show/' + dataId,
            type: 'GET',
    ...
    $(document).on('click', '.toggle-status', function() {
        var id = $(this).data('id');
        $.ajax({
            url: '{{ route('supplier.toggleStatus') }}',
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                id: id
