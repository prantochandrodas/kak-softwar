...
<div class="container-invoice">
    <!-- Top Bar -->
    <div class="top-bar">
        {{ __('messages.purchase_invoice') }} | {{ __('messages.email') }}: {{ $company_info->email }} |
    ...
    <div class="main-header">
        ...
        <div class="invoice-badge">
            ...
            <div class="invoice-type">{{ __('messages.purchase_invoice') }}</div>
        </div>
    </div>
    ...
    <div class="info-section">
        <div class="info-box">
            <h3>{{ __('messages.supplier') }} {{ __('messages.information') }}</h3>
            <div class="info-item">
                <strong>{{ __('messages.supplier') }}:</strong>
        ...
        <div class="info-box">
            ...
            <div class="info-item">
                ...
                <span>{{ date('d/m/Y', strtotime($purchase->date)) }}</span>
            </div>
            <div class="info-item">
    ...
    <div class="table-section">
        <div class="section-title">{{ __('messages.purchase') }} {{ __('messages.information') }}</div>
