        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">{{ __('messages.edit_user') }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">{{ __('messages.edit_user') }}</h4>
                </div>
                <!--begin::Card body-->
                        ...
                        <div class="row">
                            ...
                            @if ($isSuperAdmin)
                                <div id="branch_area">
                                    ...
                                    {{-- ⭐ FIRST EMPTY ROW WITH ADD BUTTON --}}
                                    ...
                                    {{-- ⭐ ALREADY SELECTED BRANCHES WITH REMOVE BUTTON --}}
                                                ...
                                                <select name="branch_id[]" class="form-select">
                                                    ...
                                                    @foreach ($branches as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $branch->branch_id == $item->id ? 'selected' : '' }}>
                                                            {{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
