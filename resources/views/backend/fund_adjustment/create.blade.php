    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('messages.fund_adjustment') }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"> {{ __('messages.fund_adjustment') }}</li>
                        <!--end::Item-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="content">
                    <form role="form" id="duePaymentForm" action="{{ route('fund-adjustment.store') }}" method="POST"
                                    ...
                                    <fieldset style="position: relative; margin-bottom:30px!important;">
                                        ...
                                        <div class="row payment-box" style="margin-top: 20px">
                                            ...
                                            <div class="col-sm-6" style="margin-top: 5px">
                                                ...
                                                <select id="type" name="type" class="form-select select2 type"
                                                    required>
                                                    <option value="">{{ __('messages.select_one') }}</option>
                                            ...
                                            <div class="col-sm-6" style="margin-top: 5px">
                                                ...
                                                <select id="fund_id" name="fund_id" class="form-select select2 fund_id"
                                                    required>
                                                    <option value="">{{ __('messages.select_one') }}</option>
                                            ...
                                            <div class="col-sm-6" style="margin-top: 5px">
                                                ...
                                                <textarea name="note" id="note" class="form-control" cols="30" rows="10" placeholder="note"></textarea>
                                            </div>

                                            <div class="mt-3 text-center">
                                                <button type="submit" class="add-more-btn btn btn-success" id="addToCart">+
