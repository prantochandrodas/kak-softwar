        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                @if (check_permission([
                    ...
                    <!--begin:Menu item-->
                    @if (check_permission(['project.list', 'project.create', 'project.edit', 'project.delete']))
                        <!--end:Menu item-->
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->is('admin/project/*', 'admin/project') ? 'active' : '' }}"
                                href="{{ route('project') }}">
                                <span class="menu-icon">
                                ...
                                <span class="path2"></span>
                                    ...
                                    <i class="fas fa-diagram-project fs-2"></i>
                                </span>
                    ...
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ request()->is('admin/users', 'admin/users/*', 'admin/roles', 'admin/roles/*') ? ' show' : '' }}">
                        <!--begin:Menu link-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            @if (check_permission(['user.list', 'user.create', 'user.edit', 'user.delete']))
                                <!--begin:Menu item-->
                                <div data-kt-menu-trigger="click"
                                    class="menu-item menu-accordion mb-1 {{ request()->is('admin/users', 'admin/users/*') ? ' show' : '' }}">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        @if (check_permission(['user.create']))
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link {{ request()->is('admin/users/create') ? ' active' : '' }}"
                            ...
                            @if (check_permission(['role.list', 'role.create', 'role.edit', 'role.delete']))
                                <!--begin:Menu item-->
                                <div data-kt-menu-trigger="click"
                                    class="menu-item menu-accordion {{ request()->is('admin/roles', 'admin/roles/*') ? ' show' : '' }}">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ request()->is('admin/website-banner') || request()->is('admin/servie') || request()->is('admin/client') || request()->is('admin/industry') ? ' show' : '' }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-abstract-28 fs-2">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->is('admin/website-banner') ? ' active' : '' }}"
                                href="{{ route('website-banner') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->is('admin/servie') ? ' active' : '' }}"
                                href="{{ route('servie') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Service-Info</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->is('admin/industry') ? ' active' : '' }}"
                                href="{{ route('industry') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                @if (check_permission(['general.settings', 'slider.update']))
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ request()->is('admin/settings/general', 'admin/settings/slider', 'admin/contact') ? ' show' : '' }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-abstract-28 fs-2">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            @if (check_permission(['slider.update']))
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ request()->is('admin/settings/slider') ? ' active' : '' }}"
                                        href="{{ route('admin.setting.slider') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
