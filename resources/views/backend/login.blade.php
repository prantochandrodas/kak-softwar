...
<head>
    <base href="../../../" />
    <title>{{ $generalSetting->name }} || Login</title>
    <meta charset="utf-8" />
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" action="{{ route('admin.login') }}" method="post">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Please enter your credentials to continue
                                </div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                style="background-image: url({{ asset('assets/backend/media/misc/auth-bg.png') }})">
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20"
                        style="background: white;" src="{{ asset('uploads/logo/' . $company->login_page_image) }}"
                        alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
